...
import com.dehong.sso.boot.shiro.MyExceptionHandler;
import com.dehong.sso.boot.shiro.MySessionManager;
import com.dehong.sso.boot.shiro.MyShiroRealm;
import com.dehong.sso.boot.shiro.RetryLimitHashedCredentialsMatcher;
...
//    }
    ...
    public SessionManager sessionManager() {
        ...
        //session的失效时长，单位毫秒
        mySessionManager.setGlobalSessionTimeout(60000*10);
        //删除失效的session
        mySessionManager.setDeleteInvalidSessions(true);

        //会话验证器调度时间
        mySessionManager.setSessionValidationInterval(20000);
        //定时检查失效的session
